  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/product/:id" element={<ProductDetail onCartAdd={handleCartAdd} />} />
        <Route path="/favorites" element={<Favorites onCartAdd={handleCartAdd} />} />
        <Route path="/compare" element={<Compare onCartAdd={handleCartAdd} />} />
        ...
        <Route path="*" element={
          <div className="page-wrapper" style={{ display:'flex', alignItems:'center', justifyContent:'center', minHeight:'60vh', textAlign:'center' }}>
            <div>
              <h2 style={{ fontFamily:'var(--font-display)', fontSize:'4rem', marginBottom:12 }}>404</h2>
